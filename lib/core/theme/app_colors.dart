...
class AppColors {
  ...
  static const Color chorusBackground = Color(0xFFF0F7F2);
  static const Color chorusBorder = Color(0xFF6FBF8A);
  static const Color chorusText = Color(0xFF166534);

  static const Color verseText = Color(0xFF374151); // Cool dark gray
  static const Color preChorusText = Color(0xFF4338CA); // Indigo-700

  static const Color bridgeBackground = Color(0xFFFFF7E6); // Soft warm cream
  static const Color bridgeBorder = Color(0xFFFFC86B); // Muted amber
  static const Color bridgeText = Color(0xFF8A5A00);
